...
const Index = () => {
  ...
  const [captionImage, setCaptionImage] = useState<File | null>(null);
  const [captionVideo, setCaptionVideo] = useState<File | null>(null);
  const [captionModel, setCaptionModel] = useState<string>("runware:150@2");
